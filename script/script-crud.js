...
const btCancelarForm = document.querySelector('.app__form-footer__button--cancel');
const btDeletarForm = document.querySelector('.app__form-footer__button--delete');
...
btDeletarForm.addEventListener('click', ()=>{
    textArea.value = '';
});

btCancelarForm.addEventListener('click', ()=>{
    textArea.value = '';
